...
module.exports = {
    ...
    logger.info("rowIndex, columnIndex " + rowIndex + " " + columnIndex);
    logger.info("boardMatrix field: " + boardMatrix[rowIndex][columnIndex]);
    logger.info("BOARD FIELD: " + BOARD_FIELDS.ROLL_AGAIN)
